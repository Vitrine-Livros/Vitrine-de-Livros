...
class LivroDAO {
    ...
    public function insert(Livro $livro) {
        ...
        $sql = "INSERT INTO livro (nome, autores, ano_lancamento, editora, id_genero, foto, link_compra, resumo)" .
               " VALUES (:nome, :autores, :anoLancamento, :editora, :idGenero, :foto, :linkCompra, :resumo)";
    ...
    public function update(Livro $livro) {
        ...
        $sql = "UPDATE usuario SET nome = :nome, autores = :autores, ano_lancamento = :ano_lancamento, editora = :editora,
         idGenero = :idGenero, foto = :foto, linkCompra = :linkCompra, resumo = :resumo" .   
               " WHERE id_usuario = :id";
